			...
			<Link to={'/recipes/312das'} className='w-full h-full overflow-hidden transition duration-150 ease-in bg-white border-white shadow cursor-pointer group relateive lg:h-full hover:outline outline-white rounded-xl hover:outline-emerald-200 hover:shadow-lg shadow-gray-600/10'>
				<div className='relative rounded-xl'>
					<div className='absolute flex justify-between w-full px-2 top-4 z-1'>
						...
						<div className='px-4 py-0.5 text-gray-800 bg-gray-100/90 font-semibold text-sm rounded-xl'>Prato principal</div>
					</div>
					<img
						src={pizza}
						alt=''
				...
				<div className='px-6 py-4 bg-white border border-gray-300 shadow '>
					<div>
						<h4 className='text-2xl font-semibold truncate transition duration-150 ease-in group-hover:text-emerald-600'>sushi caseiro - temaki de salmao</h4>
						<p className='text-gray-600 line-clamp-2'>
							Adasdlpasdlp aslpdlpa sdlpsd lpasdplasd plasdlpprenda a fazer temaki de salmão em casa! Fresco, saboroso e mais fácil do que parece.
						</p>
					</div>
					<div className='flex justify-between py-4'>
						...
						<div className='flex items-center gap-1 text-gray-500'>
							<Users2 size={16} />
							<span className='text-sm'>4 porções</span>
						</div>
					</div>
