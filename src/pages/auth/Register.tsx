			...
			<div className='absolute top-1/2 left-1/2 -translate-1/2 w-[95%] max-w-[450px] bg-white rounded-xl py-4 shadow-md'>
				<div className='px-6 py-4'>
					...
					<div className='space-y-2'>
						...
						<button className='w-full px-4 py-3 mt-4 font-semibold text-white transition duration-75 rounded-md cursor-pointer bg-emerald-600 hover:bg-emerald-700 ease'>
							Criar conta
						</button>
					</div>
				</div>
